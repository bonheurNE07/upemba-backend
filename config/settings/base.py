...
DEFAULT_FROM_EMAIL = env("DEFAULT_FROM_EMAIL", default="Upemba IoT <noreply@upemba.local>")
# ADMIN
# ------------------------------------------------------------------------------
# Django Admin URL.
ADMIN_URL = "admin/"
# https://docs.djangoproject.com/en/dev/ref/settings/#admins
ADMINS = ['"Ndeze Bonheur" <ndeze-bonheur@upemba.local>']
...
SPECTACULAR_SETTINGS = {
    "TITLE": "Upemba IoT Backend API",
    "DESCRIPTION": "Documentation of API endpoints of Upemba IoT Backend",
    "VERSION": "1.0.0",
